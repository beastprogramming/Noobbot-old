...
function WindowsResellerHosting() {
        let pricingLists = [
            {
          ...
          let specifications = [
            ...
            {title:"ASP.NET 4.x, 2.x | ASP.NET Core 1.x"},
            {title:"PHP 5.3 to 7.1 | Ajax Toolki | cURL"},
            {title:"IIS 8.5"},
            {title:"MS SQL 11.x | MySQL 5.6"},
            {title:"ionCube Loader"},
            {title:"Create Hosting Plans"},
            {title:"Set up and Modify Customer Accounts"},
            {title:"Track traffic Usage by each Customer"},
            {title:"Brand your plesk panel"},
            {title:"Add custom buttons"},
            {title:"Dedicated Plesk Panel for Clients"},
            {title:"Upload and Manage Web Pages"},
            {title:"View Website Statistics"},
            {title:"Install Over 250 Scripts with a single click"},
          ...
          let features= [
            {
                image:"/images/pages/plesk.png",
                alt:"Plesk Onyx 17.5.3",
                title:"Plesk Onyx 17.5.3",
                lists:[
          ...
          return (
            <>
              <PageHeader
                ...
                image={"/images/pages/Windows Reseller Hosting.png"}
