                        ...
                        <div className="nb-shadow-md nb-bg-white nb-rounded-b-lg">
                            ...
                            <div className="nb-p-4">
                                ...
                                <div className="nb-mt-4">
                                    ...
                                    <Link to="#" title="Learn More"><div className="nb-text-md nb-rounded-md nb-bg-gray-100 hover:nb-bg-gray-200 nb-p-2 nb-text-primary-bunty nb-font-semibold nb-text-center nb-uppercase">Learn More</div></Link>
                                </div>
                            </div>
                        </div>
